...
namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        {
            Console.WriteLine("Digite a placa do veículo para remové-lo:");
            ...
            {
                Console.WriteLine("Desculpe! Veículo não contrado. Confira se digitou a placa corretamente.");
            }
        }
        ...
        public void ListarVeiculos()
        {
            ...
            if (veiculos.Any())
            {
                ...
                Console.WriteLine($"Quantidade total de veículos:  {veiculos.Count}.");
            }
            else
            {
